...
const COPY_BEARING_NAME =
  /^(?:label|title|description|subtitle|placeholder|caption|heading|subheading|header|helperText|message|summary|tooltip|emptyTitle|emptyDescription|singular|plural|verb|cta|createCta|[A-Za-z_$][\w$]*(?:Label|Title|Description|Subtitle|Placeholder|Caption|Heading|Subheading|Header|HelperText|Message|Summary|Tooltip|Cta|CTA))$/;
